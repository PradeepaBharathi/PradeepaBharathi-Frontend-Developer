...
function Features() {
  ...
  return (
    ...
    <div
        className='flex flex-col justify-center items-center w-full lg:w-1/3 h-[480px] p-10 pb-0 bg-road m-4 lg:m-20 rounded-2xl'
       data-aos='zoom-in'
    >
        ...
        <div className='flex flex-col justify-center items-center w-full lg:w-2/3 h-[480px] lg:ml-10 lg:mr-20 bg-road rounded-2xl m-4'  data-aos='zoom-in'>
      ...
      <div className='bg-black flex flex-col lg:flex-row justify-center items-center'>
        <div className='flex flex-col justify-center items-center w-full lg:w-3/5 h-[480px] lg:ml-10 lg:mr-20 bg-road rounded-2xl m-4'  data-aos='zoom-in'>
          <div className='flex flex-col justify-center items-center mt-10'>
        ...
        <div className='flex flex-col justify-center items-center w-full lg:w-1/3 h-[480px] pt-10 pb-0 bg-road lg:mr-20 rounded-3xl m-4' data-aos='zoom-in'>
